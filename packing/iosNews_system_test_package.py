...
class TestFengzi():
    ...
    def test_fengzi(self):
        branch = 'ifengNews_7.65.0'
        self.driver.implicitly_wait(10)
        self.driver.get("http://172.30.20.14:1120/")
        self.driver.set_window_size(1936, 1056)
        time.sleep(2)
        self.driver.find_element(By.XPATH,'//*[@id="job_ifengNews"]/td[3]/a').click()
        time.sleep(2)
        ...
        self.driver.get("http://172.30.20.14:1120/job/ifengNews/" + element)
        time.sleep(600)
        ...
        # 获取div文本分支
        element = self.driver.find_element(By.XPATH, '//*[@id="main-panel"]/table/tbody/tr[3]/td[2]/ul/li')
        element1 = self.driver.find_element(By.XPATH, '//*[@id="main-panel"]/table/tbody/tr[4]/td[2]/ul/li')
        brancha = element.get_attribute('innerText')
        brancha1 =element1.get_attribute('innerText')
        print('获取分支为：',brancha1)
        ...
        mBody1 = {
            ...
            "markdown": {
                ...
                >git分支:<font color=\"comment\">"+brancha+"</font>\n\
                >flutter分支:<font color=\"comment\">"+brancha1+"</font>\n\
                >[外网点击下载>>]("+val+") \n\
