...
class TestFengzi():
    ...
    def test_fengzi(self):
        ...
        self.driver.get("http://172.30.26.42:9999/login")
        ...
        self.driver.find_element(By.XPATH, '//*[@id="yui-gen3-button"]').click()
        ...
        self.driver.get("http://172.30.26.42:9999/job/ifengnews_android_phone/" + element)
        time.sleep(300)
        ...
        mBody1 = {
            "msgtype": "markdown",
            "markdown": {
                "content": "\n<font color=\"warning\">安卓测试包</font>打包成功。\n\
